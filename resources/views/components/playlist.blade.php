        ...
        <div class="flex space-x-3">
            @if ($playlist->user)
                <div class="avatar">
                    <div class="size-10 rounded-full">
                        <img src="<https://avatars.laravel.cloud/>{{ urlencode($playlist->user->email) }}"
                            alt="{{ $playlist->user->name }}'s avatar" class="rounded-full" />
                    </div>
                </div>
            @else
            ...
            <div class="min-w-0 flex-1 space-x-3">
                <div class="flex flex-col gap-4">
                    <div class="flex items-center bg-blue-500 p-4 text-white">
                    ...
                    <div class="flex gap-1">
                        <div class="flex items-center gap-1">
                            <!-- <span class="text-sm font-semibold">{{ $playlist->user ? $playlist->user->name : 'Anonymous' }}</span> -->
